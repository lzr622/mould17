$(function () {
    ...
    $(".banner").each(function () {
        ...
        if (pointer != 0 && page > 1) {
            var point1 = '<ul class="pointer"><li value="1" class="xs3 active">MTW Heavy type Trapezium Mill</li>';
            
                point1 = point1 + ' <li  value="2" class="xs3">MB5X Grinding Mill</li>';
                point1 = point1 + ' <li value="3" class="xs3">LM Vertical Mill</li>'
                point1 = point1 + ' <li value="4" class="xs3">MTW Trapezium Mill</li>'
            ...
            var lefter = $('<div class="pager-prev"><img src="./img/index/left-arrow.png" alt="" class="img-tran"></div>');
            var righter = $('<div class="pager-next"><img src="./img/index/right-arrow.png" alt="" class="img-tran"></div>');
            if (style != null) {
